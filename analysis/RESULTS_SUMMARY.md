...
- MoE fused EO/IR degraded: **65.5%**
- MoE lock >= 60s: **65.5%**
- Build-up p50: 10.1s (p90: 12.6s)
- Duration p50: 197.7s (p10: 170.1s)
- Area p50: 57.6 sq ft
- KPP checks: build_up_p90_le_15s: PASS | duration_p10_ge_120s: PASS | area_p10_ge_30_sqft: PASS | moe_lock_break_p50_ge_60s: PASS

## Wind Sensitivity (3 grenade)

- **calm_0_5mph**: MoE lock>=60s 99.3%, duration p50 198s
- **moderate_5_10mph**: MoE lock>=60s 85.2%, duration p50 198s
- **high_10_15mph**: MoE lock>=60s 63.2%, duration p50 197s
