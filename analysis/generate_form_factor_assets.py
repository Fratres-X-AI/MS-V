...
def write_report(
    ...
    lines = [
        ...
        f"| Archived MC stressed p10 / p50 / p90 | {throw_stats['throw_p10_m']:.1f} / {throw_stats['throw_p50_m']:.1f} / {throw_stats['throw_p90_m']:.1f} m (old p10 was floored) |",
        ...
        f"RTM: matrix KPP-08 · job `{hf_summary['rtm_job_kpp08']}` (archived MC number is **not closed**; old p10 was floored and is **not** range validation).",
        "",
