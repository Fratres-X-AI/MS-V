...
> **Method:** Saltelli + Sobol (SALib) · N=16,384 · evaluations=425,984
...
| 3 | `filler_mass_g` | 0.0447 | 0.0452 | P0 burn cup |
...
- Duration Y: mean=187.7s p10=160.0s p50=185.6s p90=218.8s
