...
| | |
|--|--|
| **Maturity** | Concept docs (v2) + Phase 0/1 scaffold |
| **Internal ceiling** | TRL 2–3 (M&S package) |
| **Today** | Phase 0 RTM audit + Phase 1 Monte Carlo |
...
| Path | Purpose |
|------|---------|
| [**MasterPlan.md**](MasterPlan.md) | Phased plan, TRL honesty, today's actions |
