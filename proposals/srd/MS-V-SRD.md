...
| KPP-05 | Modeled group 2–3 grenades | NOT_CLOSED | KPP-05 | paired-plume test |
| KPP-06 | VIS+NIR+MWIR | NOT_CLOSED | KPP-06 | E-1 / 2B |
| KPP-07 | Fuze 0.7–2.0 s | NOT_CLOSED | KPP-07 | P2 fuze test |
| KPP-08 | Throw ≥ 20 m p10 | NOT_CLOSED | KPP-08 | E-2 / 2C |
| KPP-09 | 7.1×3.1 in envelope | DESIGN_AUTHORITY | KPP-09 | E-3 |
| KPP-10 | −20 to +50 °C | SENSITIVITY_PASS | KPP-10 | E-5 / 2E |
| KPP-11 | ≤ 15 mph wind | NOT_CLOSED | KPP-11 | range |
| KPP-12 | Respiratory exposure | UNVERIFIED | KPP-12 | E-1 tox |
| KPP-13 | Cost $75–150 | PLANNED | KPP-13 | Phase 4 |
| KPP-14 | 1–2 per soldier | NOT_CLOSED | KPP-14 | logistics after tox |
| MOE-01 | Lock-break ≥ 60 s | NOT_CLOSED | MOE-01 | E-4 / 2D |
| MOE-02 | CASEVAC window | NOT_CLOSED | MOE-02 | CONOPS MC shows miss |
...
| KPP-05 | `baseline_10M_g2_*`; `baseline_10M_g3_*` | 44; 45 | NO | Modeled scenario only |
| KPP-06 | `baseline_10M_g3_n10000000` | 45 | NO | Saturated equation; not measured cloud |
| KPP-07 | `baseline_10M_g3_n10000000` | 45 | NO | Circular sampled delay; not lot test |
| KPP-08 | `baseline_10M_g3_n10000000` | 45 | NO | Published 20.0 m was floored |
| KPP-10 | `sweep_temp_hot_g3_n2000000` (tightest) | 735 | YES | Chamber confirmation E-5 |
| KPP-11 | `baseline_10M_wind_high_g3_n10000000` | 208 | NO | Model is not wind-sensitive |
| MOE-01 | `baseline_10M_g3_n10000000` | 45 | NO | **A-013:** ~80% planning surrogate — not field MoE |
| MOE-01 stress | `baseline_10M_adversarial_g3_n10000000` | 999 | NO | Adversarial ~55% still surrogate |
| MOE-02 | CONOPS (`sim/run_conops.py`) | — | NO | Casevac lock-met ~14.9%; not a procedure |
...
| KPP-05 | Group 2–3 grenades | **Not closed** — modeled scenario only | Paired-plume range test |
| KPP-06 | VIS + NIR + MWIR | **Not closed** — saturated model output | Spectrometer α(λ) |
| KPP-07 | Fuze M201A1 0.7–2.0 s | **Not closed** — circular sampling | Fuze lot test |
| KPP-08 | Throw ≥ 20 m (p10 stressed) | **Not closed** — old p10 was floored | Loaded throw range |
...
| KPP-11 | ≤ 15 mph wind | **Not closed** — model not wind-responsive | Range plume |
| KPP-12 | Respiratory exposure | **UNVERIFIED** | Toxicology panel |
| KPP-13 | Cost $75–150 | **PLANNED** | Manufacturing study |
| KPP-14 | 1–2 per soldier | **Not closed** — toxicology blocks issue | Logistics after tox |

## 5. Measures of Effectiveness

| ID | Requirement | M&S Status | Verification Path |
|----|-------------|------------|-------------------|
| MOE-01 | Fused EO/IR lock-break ≥ 60 s | **Not closed** — planning surrogate only | UAS surrogate range test |
| MOE-02 | CASEVAC T+15–135 s window | **Not closed** — CONOPS MC misses casevac | [`analysis/CONOPS_REPORT.md`](../analysis/CONOPS_REPORT.md) |
...
| Requires visual smoke (not standalone) | LIM-01 | Model scenario only |
...
| **E-2** | KPP-08 | Published p10 of 20.0 m was floored. Not closed. | n≥30 loaded throw range | **2C** |
